...
1)У всех ссылок, button и прочих интерактивных элементах должен быть hover. Если в дизайне ховер не показан, делаем opacity 0.8 2) Всплывающие окна закрываются при клике на overlay
